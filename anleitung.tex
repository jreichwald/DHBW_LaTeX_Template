...
Diese Vorlage beinhaltet die folgenden, in Tabelle \vref{tab:dateien} aufgelisteten Dateien: 
\begin{table}[h!]
	\centering
...
Acronym dann nur noch in der Kurzform dargestellt: \ac{DHBW}.

\section{Zitieren von Quellen}
Mit dem Befehl \texttt{autocite} kann zitiert werden, z.\,B. so\autocite[Vgl.][S. 18ff.]{ME12}.
 Die Übernahme zitierter Quellen oder Akronyme in die 
